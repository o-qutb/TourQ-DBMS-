...
public class TripTime extends JFrame {
	...
	public TripTime() {
		...
		JLabel lblNewLabel_3 = new JLabel("Start_Time");
		lblNewLabel_3.setBounds(109, 128, 70, 13);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) 
			{
				try {
					Utility ut=new Utility();
					String sql="update tour_trip set Duration = ?, Start_Time = ?  where TourNo = ? and TripDate = ? ";
					ut.conn.setAutoCommit(false);
					ut.pstmt=ut.conn.prepareStatement(sql);
					ut.pstmt.setString(1, V3.getText());
					ut.pstmt.setTimestamp(2,java.sql.Timestamp.valueOf(V4.getText()));
					ut.pstmt.setDate(4, java.sql.Date.valueOf(V2.getText()));
					ut.pstmt.setString(3, V1.getText());
					ut.pstmt.executeUpdate();
