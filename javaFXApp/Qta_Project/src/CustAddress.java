...
public class CustAddress extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CustAddress frame = new CustAddress();
	...
	public CustAddress() {
		...
		JLabel lblNewLabel_3 = new JLabel("Building");
